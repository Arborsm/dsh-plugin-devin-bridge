window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function parseFamily(label) {
			return label.replace(/\s*\b(Max|High|Medium|Low|No Thinking)\b\s*/gi, "").trim() || label;
		}
		/** 把候选模型按 family 分组。 */
						...
						children: [
							...
							groupCandidatesByFamily(candidates).map(({ family, models }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
