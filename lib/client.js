window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function parseCandidateInfo(model) {
		...
		function groupCandidatesByFamily(models) {
			...
			for (const m of models) {
				...
				if (rawLabel.includes("Lightning") && !family.includes("Lightning")) family = family + " Lightning";
				if (!family) family = m.id;
				const arr = groups.get(family) ?? [];
				arr.push(m);
				groups.set(family, arr);
			}
			return [...groups.entries()].map(([family, ms]) => ({
				family,
				models: ms
			})).sort((a, b) => {
				const aFree = a.models.some((m) => m.name?.includes("[Free]"));
				if (aFree !== b.models.some((m) => m.name?.includes("[Free]"))) return aFree ? -1 : 1;
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
								...
								children: [
									...
									" models available, ",
									picked.size,
									" selected. Grouped by family."
								]
							}),
							groupCandidatesByFamily(candidates).map(({ family, models }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "devin-bridge-family-group",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "devin-bridge-family-header",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "devin-bridge-family-name",
										children: family
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "devin-bridge-family-count",
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
											...
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
												...
												children: [
													...
													info.isPromo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "devin-bridge-model-tag devin-bridge-tag-promo",
														children: "Promo"
													}),
													info.isPremium && !info.isPromo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													...
													model.contextWindow && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														...
														children: [(model.contextWindow / 1e3).toFixed(0), "k"]
													}),
													info.creditMultiplier && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														className: "devin-bridge-model-tag",
														children: [info.creditMultiplier, "x"]
													})
												]
											})
										}, model.id);
						...
						children: models.map((model, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									model.isPromo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "devin-bridge-model-tag devin-bridge-tag-promo",
										children: "Promo"
									}),
									model.isPremium && !model.isPromo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "devin-bridge-model-tag devin-bridge-tag-premium",
										children: "Premium"
									}),
